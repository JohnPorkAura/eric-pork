"""
Eric pork — Write your perfect ad!
...
DB_FILE      = "eric_pork.db"
SYSTEM_PROMPT = "You are an expert Eric pork assistant. Describe your product and target audience. Get platform-specific ad copy for Google, Facebook, or LinkedIn."

app = FastAPI(title="Eric pork")
...
<div id="auth-overlay">
  <div class="auth-box">
    <div class="auth-logo">Eric pork</div>
    <div class="auth-sub">Write your perfect ad!</div>
    <div class="auth-tabs">
...
<div class="wrap" id="main-app" style="display:none">
  <div class="hero">
    ...
    <h1><em>Eric pork</em><br>Write your perfect ad!</h1>
    <p>Describe your product and target audience. Get platform-specific ad copy for Google, Facebook, or LinkedIn. Built for users.</p>
  </div>
  ...
  <div class="card" id="input-card">
    <div class="card-hd">
      ...
      <input type="text" id="field-product" placeholder="" required>
    </div>
    <div class="field">
      <label for="field-target_audience">target audience</label>
      <input type="text" id="field-target_audience" placeholder="">
    </div>
    <div class="field">
      <label for="field-platform">platform</label>
      <input type="text" id="field-platform" placeholder="">
    </div>
    <div class="field">
      <label for="field-goal">goal</label>
      <input type="text" id="field-goal" placeholder="">
    </div>
    <div class="field">
      <label for="field-topic">Topic</label>
      <textarea id="field-topic" placeholder=""></textarea>
    </div>
    <div class="btn-row">
  ...
  <footer>
    <div class="foot-note">Eric pork &middot; Powered by Groq llama-3.3-70b</div>
...
const APP = {
  ...
  systemPrompt:   "You are an expert Eric pork assistant. Describe your product and target audience. Get platform-specific ad copy for Google, Facebook, or LinkedIn.",
  promptTemplate: "product: {{product}}\\ntarget audience: {{target_audience}}\\nplatform: {{platform}}\\ngoal: {{goal}}\\nTopic: {{topic}}",
  resultFormat:   'list', // text | list | steps
  resultConfig:   {"label": "Result", "copyable": true},
  inputs:         [{"id": "product", "label": "product", "type": "text", "placeholder": "", "required": true, "options": []}, {"id": "target_audience", "label": "target audience", "type": "text", "placeholder": "", "required": false, "options": []}, {"id": "platform", "label": "platform", "type": "text", "placeholder": "", "required": false, "options": []}, {"id": "goal", "label": "goal", "type": "text", "placeholder": "", "required": false, "options": []}, {"id": "topic", "label": "Topic", "type": "textarea", "placeholder": "", "required": false, "options": []}],
};
...
@app.get("/api/health")
def health():
    return {"status": "ok", "app": "Eric pork", "ai_ready": bool(GROQ_API_KEY)}
